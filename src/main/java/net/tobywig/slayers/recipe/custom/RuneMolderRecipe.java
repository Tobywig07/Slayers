...
import net.tobywig.slayers.util.FluidJSONUtil;
...
public class RuneMolderRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<RuneMolderRecipe> {
        ...
        public RuneMolderRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new RuneMolderRecipe(pRecipeId, output, inputs, fluid);
        }
        ...
        public @Nullable RuneMolderRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new RuneMolderRecipe(id, output, inputs, fluid);
        }
