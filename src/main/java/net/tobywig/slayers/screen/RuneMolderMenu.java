...
public class RuneMolderMenu extends AbstractContainerMenu {
    ...
    public RuneMolderMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.RUNE_MOLDER_MENU.get(), id);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 2, 151, 15));
            this.addSlot(new SlotItemHandler(handler, 3, 52, 58));
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.RUNE_MOLDER.get());
    }
